...
const About = ({ isDarkMode }) => {
  return (
    <motion.div
      id="about"
      className="w-full max-w-[1440px] mx-auto px-[6%] sm:px-6 lg:px-10 py-10 scroll-mt-20"
      initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl mx-auto font-Ovo">
            I am a dedicated Frontend Developer with 3 years of professional
            experience. Over the years, I have contributed to impactful projects
            and collaborated with forward-thinking teams, helping drive
            user-centric solutions and business growth.
          </p>
